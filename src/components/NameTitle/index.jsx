...
const NameTitle = () => {
    return (
        <>
            <div className="absolute bottom-0 bg-gradient-to-t from-[#111] to-transparent h-1/2 z-40 w-full sm:w-[550px] left-1 sm:left-auto flex flex-col items-center justify-end sm:gap-2 p-5  sm:p-10">
                <h2 className="text-xl sm:text-5xl font-bold">زهرا حسن بستی</h2>
                <h4 className="text-cyan-400">Frontend Developer</h4>
                <div className="flex gap-2 mt-1 sm:mt-0 sm:gap-5">
